...
CREATE TABLE characters (
   ...
   name VARCHAR(255),
    ...
    INSERT INTO characters (name, gender, hair_colour, eye_colour, glasses, piercings, beard, london, pets, hair_accessory, top_colour) VALUES ('Robyn', 'female', 'blonde', 'green', TRUE, TRUE, FALSE, FALSE, TRUE, TRUE, 'red');
